"""" Fitting to Exponential-Gaussian Hybrid equation """

"""


Using Exponential Gaussian Hybrid
...
#C30 start & end times = 41.929 & 42.119 mins
#C30 start & end times = 41.929 & 42.125 mins
#C30 start & end times = 41.683 & 42.326 mins extended version
#hopanes start & end times = 39.135 & 46.357
start_time = 39.135
end_time = 46.357
C30_start_time = 41.683
C30_end_time = 42.326
hC30_1_est = []
scan_hC30_1_est = []
condition_array = []
...
textfile = open('/home/geraldfj/Documents/python/LR_ML1/y_data','w')
textfile.close()

textfile = open('/home/geraldfj/Documents/python/LR_ML1/X_data','w')
textfile.close()



for i in range(y_left.shape[0]):
    textfile = open('/home/geraldfj/Documents/python/LR_ML1/y_data','a')
...
for i in range(x1.shape[0]):
    textfile = open('/home/geraldfj/Documents/python/LR_ML1/X_data','a')
